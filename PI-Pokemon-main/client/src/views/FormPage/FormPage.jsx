...
import snorlax from "../../Imagenes/snorlax.gif";
  ...
  return (
    <div className={styles.containerF}>
      ...
      <div className={styles.necesitasP}>
        <NavLink to="/home" className={styles.spanBo} >
        <button className={styles.buttonVolver}>
            <svg
              height="16"
              width="16"
            ...
            <span className={styles.spanV}>Home</span>
          </button>
        </NavLink>
        ...
        <div className={styles.formContainer}>
              ...
              <h3 className={styles.formTitle}>Crea un pokemon</h3>
                ...
                <input type="number" id="hp" name="hp" required onChange={handleInputChange} className={styles.inputContainer} /><br /><br />
                {
                  errors.hp && 
                  <span className={styles.error}>{
                    errors.hp
                ...
                <input type="number" id="attack" name="attack" required onChange={handleInputChange} className={styles.inputContainer} /><br /><br />
                {
                  errors.attack && 
                  <span className={styles.error}>{
                    errors.attack
                ...
                <input type="number" id="defense" name="defense" required onChange={handleInputChange} className={styles.inputContainer} /><br /><br />
                {
                  errors.defense && 
                  <span className={styles.error}>{
                    errors.defense
                ...
                <input type="number" id="speed" name="speed" onChange={handleInputChange} className={styles.inputContainer} /><br /><br />
                {
                  errors.speed && 
                  <span className={styles.error}>{
                    errors.speed
                ...
                <input type="number" id="height" name="height" onChange={handleInputChange} className={styles.inputContainer} /><br /><br />
                {
                  errors.height && 
                  <span className={styles.error}>{
                    errors.height
                ...
                <input type="number" id="weight" name="weight" onChange={handleInputChange} className={styles.inputContainer} /><br /><br />
                {
                  errors.weight && 
                  <span className={styles.error}>{
                    errors.weight
                ...
                <label htmlFor="types" className={styles.typeS}>Type: </label>
                <div> 
                  <select id="types" multiple={true} onChange={handleTypeChange} className={styles.selectType} >
                    {
                      types.map((tipo)=>(
                        <option className={styles.opciones} value={tipo.name}>
                          {tipo.name }
                        </option>
                      ))
                    }
              ...
              >
                ...
                <span className={styles.pika1}>Henry</span>
                <span className={styles.pika2}>Creando!</span>
              </button>
            </div>
              </form>
           </div>  
